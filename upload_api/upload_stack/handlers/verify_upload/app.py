...
queue = sqs.get_queue_by_name(QueueName=transform_queue_name)
...
def lambda_handler(event, context):
    ...
    for record in records:
        ...
        queue.send_message(MessageBody=json.dumps({'user': userid, 'fileurl': object_url,'bucket':bucket, 'key':key, 'filename':filename}))
